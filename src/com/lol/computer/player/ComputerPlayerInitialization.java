...
public class ComputerPlayerInitialization {
	...
	/**
	 * This method is used to initialize the data structure in the form of circular
	 * linked list
	 * 
	...
	public static void initTerrainTokenMap(Integer numOfPlayers) {
		...
		// adding direction to the location
	...
	/**
	 * This method is used the update the personal, open and bonus information at
	 * the start of game
	 * 
	...
	public static void updatePersonalTokenMap(List<String> messageDetailsList, String playerName,
		...
		for (String player : PlayerList) { // marking 1 for having the token
	...
	/**
	 * This method is used to update the location with playing player, which is not
	 * with him
	 * 
	 * @param playerName
	 */
